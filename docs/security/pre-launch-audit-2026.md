...
| DAST-001 | Passive DAST (ZAP baseline) | MITIGATED | `zap-baseline-2026.json`; ZAP header above | Passive baseline against RC URL `http://127.0.0.1/` (auth none); see ZAP header. | — | Composer / 2026-05-22 |
